...
export default function TodoListItem({ todo, onRemovePressed, onMarkAsCompletedPressed }) {
    ...
    return (
        <Container createdAt={todo.createdAt}>
            ...
            <ButtonsContainer>
                {todo.isCompleted === false && <CompletedButton
                    onClick={() => onMarkAsCompletedPressed(todo.id)}>Mark As Completed</CompletedButton>}
                <RemovedButton
                    onClick={() => onRemovePressed(todo.id)}>Remove</RemovedButton>
            </ButtonsContainer>
        </Container>
    )
}
